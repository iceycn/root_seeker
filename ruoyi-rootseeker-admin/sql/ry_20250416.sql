...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'RootSeeker', 0, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'RootSeeker', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'RootSeeker', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    'RootSeeker', '00', 'ry@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', 'RootSeeker 官网', '0', '4', 'https://gitee.com/icey_1/root_seeker', 'menuBlank', 'C', '0', '1', '', 'fa fa-location-arrow', 'admin', sysdate(), '', null, 'RootSeeker 官网地址');
-- 二级菜单
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：RootSeeker 管理端新版本发布', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：RootSeeker 管理端系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', 'RootSeeker 介绍', '1', '<p><span style=\"color: rgb(230, 0, 0);\">项目介绍</span></p><p><font color=\"#333333\">RootSeeker 是 AI 日志根因分析工具，通过分析应用日志快速定位问题根因。</font></p><p><span style=\"color: rgb(230, 0, 0);\">RootSeeker 管理端</span></p><p><span style=\"color: rgb(51, 51, 51);\">RootSeeker 管理端负责 Git 仓库与 AI 应用配置管理，与 RootSeeker 分析服务 HTTP 协同。主要功能包括：</span></p><p><span style=\"color: rgb(51, 51, 51);\">· Git 仓库管理：拉取、同步、分支配置</span></p><p><span style=\"color: rgb(51, 51, 51);\">· 凭证配置：Gitee/GitHub/GitLab/Codeup</span></p><p><span style=\"color: rgb(51, 51, 51);\">· AI 应用配置：LLM、Embedding、Qdrant 等</span></p><p><span style=\"color: rgb(51, 51, 51);\">· 配置双模式：file（配置文件）/ database（数据库）</span></p><p><span style=\"color: rgb(51, 51, 51);\">· 配置变更与仓库变更自动通知 RootSeeker</span></p><p><span style=\"color: rgb(230, 0, 0);\">官网</span></p><p><span style=\"color: rgb(51, 51, 51);\">RootSeeker 官网：</span><a href=\"https://gitee.com/icey_1/root_seeker\" target=\"_blank\">https://gitee.com/icey_1/root_seeker</a></p>', '0', 'admin', sysdate(), '', null, '管理员');
