...
**自行安装**：详见 [依赖组件安装指南](../安装依赖.md)，含 Qdrant、Zoekt 的 Docker/二进制/Go 安装步骤。
...
详见 [Web管理端若依架构.md](../Web管理端若依架构.md) 第六节、[root_seeker_docker/README.md](../root_seeker_docker/README.md)。
...
- 项目结构与优化建议见上级目录 [项目结构.md](../项目结构.md)、[优化清单.md](../优化清单.md)。
- 设计与需求总览（含项目检查结论）见 [设计与需求.md](../设计与需求.md)；文档整合索引见 [DOCUMENTATION_INDEX.md](../DOCUMENTATION_INDEX.md)。
